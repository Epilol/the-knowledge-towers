...
public class SecondTowerWall extends Wall 
{
	...
	public SecondTowerWall(float x, float y, GameMap map)
	{
		this(x, y, map, false);
	}
	
	public SecondTowerWall(float x, float y, GameMap map, boolean isHiddenPath)
	{
