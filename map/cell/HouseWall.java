...
public class HouseWall extends Wall 
{
	private static final String WALL_PATH = "images/cell/house_wall.png";
	private static Image wallImage;
	
	private ImageLayer wallLayer;
	
	public HouseWall(float x, float y, GameMap map)
	{
		this(x, y, map, false);
	}
	
	public HouseWall(float x, float y, GameMap map, boolean isHiddenPath)
	{
