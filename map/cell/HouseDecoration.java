...
public class HouseDecoration extends Cell
{
	private static final String DECORATION_PATH = "images/cell/house_decoration.png";
	private static Image decorationImage;
	
	private ImageLayer decorationLayer;
	
	public HouseDecoration(float x, float y, GameMap map)
	{
