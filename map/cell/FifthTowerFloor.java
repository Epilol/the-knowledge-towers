...
public class FifthTowerFloor extends Cell 
{
	private static final String FLOOR_PATH = "images/cell/fifth_tower_floor.png";
	private static Image floorImage;
	
	private ImageLayer floorLayer;
	
	public FifthTowerFloor(float x, float y, GameMap map)
	{
