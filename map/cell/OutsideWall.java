...
{
	private static final String WALL_PATH = "images/cell/outside_wall.png";
	private static Image wallImage;
	
	private ImageLayer wallLayer;
	
	public OutsideWall(float x, float y, GameMap map)
	{
		this(x, y, map, false);
	}
	
	public OutsideWall(float x, float y, GameMap map, boolean isHiddenPath)
	{
