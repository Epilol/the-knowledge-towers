...
public class MagmatronFloor extends Cell 
{
	private static final String FLOOR_PATH = "images/cell/magmatron_floor.png";
	private static Image floorImage;
	
	private ImageLayer floorLayer;
	
	public MagmatronFloor(float x, float y, GameMap map)
	{
