...
public class OutsideDecoration extends Cell
{
	private static final String DECORATION_PATH = "images/cell/outside_decoration.png";
	private static Image decorationImage;
	
	private ImageLayer decorationLayer;
	
	public OutsideDecoration(float x, float y, GameMap map)
	{
