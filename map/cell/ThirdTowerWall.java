...
public class ThirdTowerWall extends Wall 
{
	...
	public ThirdTowerWall(float x, float y, GameMap map)
	{
		this(x, y, map, false);
	}
	
	public ThirdTowerWall(float x, float y, GameMap map, boolean isHiddenPath)
	{
