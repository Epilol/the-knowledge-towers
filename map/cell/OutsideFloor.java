...
public class OutsideFloor extends Cell 
{
	private static final String FLOOR_PATH = "images/cell/outside_floor.png";
	private static Image floorImage;
	
	private ImageLayer floorLayer;
	
	public OutsideFloor(float x, float y, GameMap map)
	{
