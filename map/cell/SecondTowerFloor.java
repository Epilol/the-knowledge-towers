...
public class SecondTowerFloor extends Cell 
{
	private static final String FLOOR_PATH = "images/cell/second_tower_floor.png";
	private static Image floorImage;
	
	private ImageLayer floorLayer;
	
	public SecondTowerFloor(float x, float y, GameMap map)
	{
