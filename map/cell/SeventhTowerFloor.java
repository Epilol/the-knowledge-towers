...
public class SeventhTowerFloor extends Cell 
{
	private static final String FLOOR_PATH = "images/cell/tower_floor.png";
	private static Image floorImage;
	
	private ImageLayer floorLayer;
	
	public SeventhTowerFloor(float x, float y, GameMap map)
	{
