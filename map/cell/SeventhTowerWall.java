...
public class SeventhTowerWall extends Wall 
{
	private static final String WALL_PATH = "images/cell/second_tower_wall.png";
	private static Image wallImage;
	
	private ImageLayer wallLayer;
	
	public SeventhTowerWall(float x, float y, GameMap map)
	{
		this(x, y, map, false);
	}
	
	public SeventhTowerWall(float x, float y, GameMap map, boolean isHiddenPath)
	{
