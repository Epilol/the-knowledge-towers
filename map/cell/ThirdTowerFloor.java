...
public class ThirdTowerFloor extends Cell 
{
	private static final String FLOOR_PATH = "images/cell/third_tower_floor.png";
	private static Image floorImage;
	
	private ImageLayer floorLayer;
	
	public ThirdTowerFloor(float x, float y, GameMap map)
	{
