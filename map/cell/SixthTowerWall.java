...
public class SixthTowerWall extends Wall 
{
	...
	public SixthTowerWall(float x, float y, GameMap map)
	{
		this(x, y, map, false);
	}
	
	public SixthTowerWall(float x, float y, GameMap map, boolean isHiddenPath)
	{
