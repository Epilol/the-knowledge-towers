...
public class EighthTowerWall extends Wall 
{
	...
	public EighthTowerWall(float x, float y, GameMap map)
	{
		this(x, y, map, false);
	}
	
	public EighthTowerWall(float x, float y, GameMap map, boolean isHiddenPath)
	{
