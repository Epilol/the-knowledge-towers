...
public class FifthTowerWall extends Wall 
{
	private static final String WALL_PATH = "images/cell/fifth_tower_wall.png";
	private static Image wallImage;
	
	private ImageLayer wallLayer;
	
	public FifthTowerWall(float x, float y, GameMap map)
	{
		this(x, y, map, false);
	}
	
	public FifthTowerWall(float x, float y, GameMap map, boolean isHiddenPath)
	{
