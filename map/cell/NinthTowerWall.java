...
public class NinthTowerWall extends Wall 
{
	...
	public NinthTowerWall(float x, float y, GameMap map)
	{
		this(x, y, map, false);
	}
	
	public NinthTowerWall(float x, float y, GameMap map, boolean isHiddenPath)
	{
