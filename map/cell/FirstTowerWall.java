...
public class FirstTowerWall extends Wall 
{
	private static final String WALL_PATH = "images/cell/tower_wall.png";
	private static Image wallImage;
	
	private ImageLayer wallLayer;
	
	public FirstTowerWall(float x, float y, GameMap map)
	{
		this(x, y, map, false);
	}
	
	public FirstTowerWall(float x, float y, GameMap map, boolean isHiddenPath)
	{
