...
public class Wand extends StaticSpell
{
	// TODO sistemare interfaccia e questi campi (che vanno bene pubblici)
	private static final IDimension SIZE = new Dimension(11.0f, 27.0f);
	private static final String PATH = "images/spells/wand.png";
	...
	public static final float MAX_DAMAGE = 3.5f;
	public static final float MANA_COST = 1.0f;
	public static final float CRITICAL_CHANCE = 0.1f;
	public static final float COOLDOWN = 350.0f;
	...
	public Wand(float x, float y, Player player, float damageModifier)
	{
