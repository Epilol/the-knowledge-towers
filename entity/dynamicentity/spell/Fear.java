...
public class Fear extends AnimatedSpell
{
	// TODO sistemare interfaccia e questi campi (che vanno bene pubblici)
	private static final IDimension SIZE = new Dimension(80.0f, 80.0f);
	private static final String PATH = "images/spells/fear.png";
	...
	public static final float COOLDOWN = 16000.0f;
	...
	public static final float BASE_FEAR_DURATION = 2000.0f;
	
	private static Image image;
	private float fearDurationModifier;
	
	public Fear(float x, float y, Player player, float fearDurationModifier)
	{
		super(x, y, SIZE, player);
		this.fearDurationModifier = fearDurationModifier;
	...
	public void applyEffect(Enemy enemy)
	{
		...
		enemy.fear(BASE_FEAR_DURATION * fearDurationModifier);
	}
