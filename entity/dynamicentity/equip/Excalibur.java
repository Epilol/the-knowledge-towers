...
public class Excalibur extends PhysicsWeapon
{
	private static final IDimension SIZE = new Dimension(30.0f, 30.0f);
	...
	private static final String PATH = "images/equip/excalibur.png";
	private static final float MIN_DAMAGE = 5.8f;
	private static final float MAX_DAMAGE = 6.1f;
	...
	private static final float ENDURANCE_COST = 75.0f;
	public static final float KNOCKBACK_RATE = 120.0f;
	private static Image image;
	
	public Excalibur(float x, float y, GameMap map, boolean isEnemyEquip, int level)
	{
	...
	public Excalibur(float x, float y, GameMap map)
	{
