...
public class OldWarriorSword extends PhysicsWeapon
{
	...
	private static final String PATH = "images/equip/oldwarrior_sword.png";
	private static final float MIN_DAMAGE = 2.8f;
	private static final float MAX_DAMAGE = 2.9f;
	...
	private static final float ENDURANCE_COST = 20.0f;
	public static final float KNOCKBACK_RATE = 80.0f;
	private static Image image;
	
	private IPoint frameLocation;
	
	public OldWarriorSword(float x, float y, GameMap map, boolean isEnemyEquip, int level)
	{
	...
	public OldWarriorSword(float x, float y, GameMap map)
	{
