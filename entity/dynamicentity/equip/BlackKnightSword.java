...
public class BlackKnightSword extends PhysicsWeapon
{
	...
	private static final String PATH = "images/equip/blackknight_sword.png";
	private static final float MIN_DAMAGE = 4.7f;
	private static final float MAX_DAMAGE = 4.9f;
	private static final float CRITICAL_CHANCE = 0.1f;
	private static final float SWING_TIME = 30.0f;
	private static final float SWING_COOLDOWN = 900.0f;
	private static final float ENDURANCE_COST = 35.0f;
	public static final float KNOCKBACK_RATE = 40.0f;
	private static Image image;
	
	public BlackKnightSword(float x, float y, GameMap map, boolean isEnemyEquip, int level)
	{
	...
	public BlackKnightSword(float x, float y, GameMap map)
	{
