...
{
	private static final String ICON_PATH = "images/static_objects/life_potion.png";
	private static final String TOOLTIP_PATH = "images/static_objects/tooltip.png";

	private static Image iconImage;
	private PotionType type;
	
	public LifePotion(PotionType type, int index)
	{
	...
	{
		setTooltipText(new Text("Increase the life by " + type.getValue(), Font.Style.PLAIN, 12, 0xFFFFFFFF));
